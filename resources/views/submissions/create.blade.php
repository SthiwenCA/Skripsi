<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 sm:p-10 bg-white shadow-lg sm:rounded-2xl border border-gray-100">
                <div class="max-w-2xl mx-auto">
                    ...
                    <form id="upload-form" method="POST" action="{{ route('submissions.store') }}" enctype="multipart/form-data" class="space-y-8">
                        @csrf
                        ...
                        <div class="flex justify-end pt-4">
                            <button id="submit-btn" type="submit" class="inline-flex justify-center items-center px-8 py-3 bg-[#4a3219] rounded-full font-bold text-white tracking-widest hover:bg-[#382314] active:bg-[#281a0d] transition shadow-md">
                                SUBMIT LAPORAN
                            </button>
                        </div>
                    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ==========================================
            // PERUBAHAN: LOGIKA MENCEGAH SPAM CLICK
            // ==========================================
            const uploadForm = document.getElementById('upload-form');
            const submitBtn = document.getElementById('submit-btn');

            uploadForm.addEventListener('submit', function(e) {
                // Pastikan form sudah valid (foto & koordinat sudah terisi) sebelum tombol dimatikan
